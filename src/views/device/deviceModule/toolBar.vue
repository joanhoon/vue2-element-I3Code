  ...
  <div class="toolbar">
    <div class="tool-container clearfix">
      ...
      <el-button class="filter-item" type="primary" v-waves>
        <icon-svg icon-class="edit"></icon-svg>&nbsp;运行 </el-button>
      <el-button class="filter-item" type="primary" v-waves>
        <icon-svg icon-class="edit"></icon-svg>&nbsp;关闭 </el-button>
      <el-button class="filter-item" type="primary" v-waves>
        <icon-svg icon-class="edit"></icon-svg>&nbsp;故障 </el-button>
      <el-button class="filter-item" type="primary" v-waves>
        <icon-svg icon-class="edit"></icon-svg>&nbsp;采集配置 </el-button>
