<template>
  <el-table id="treegrid" :data="data" @selection-change="changeFun" border style="width: 100%" :row-style="showTr" height=x stripe>
  ...
  export default {
    ...
    methods: {
      ...
      handleEdit(index, row) { //显示编辑界面
        bus.$emit("edit-form", row, this.dataSource); //发送事件的组件
      },
