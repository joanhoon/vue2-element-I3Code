<template>
  <el-dialog id="userRM" title="用户角色维护" v-model="anchor" size='large' top="5%">
...
<script>
  ...
  export default {
    ...
    updated() {
      let userRM = document.querySelector("#userRM");
      let table = userRM.querySelector(".el-table__body-wrapper");
