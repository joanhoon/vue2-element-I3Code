<template>
  <el-dialog id="userDA" title="用户数据权限管理" v-model="dataAuthority" size='large' top='5%'>
    <el-row :gutter="20">
      <el-col :span="12">
...
<script>
  ...
  export default {
    ...
    updated() {
      let userDA = document.querySelector("#userDA");
      let table = userDA.querySelectorAll(".el-table__body-wrapper");
